                ...
                <div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                @foreach (Cart::content(2,',','') as $product)
                                <tr>
                                    ...
                                    <td class="border-0 align-middle"><strong>{{ getPrice(Cart::subtotal(2,',','')) }}</strong></td>
            ...
            <div class="row p-4 bg-white rounded shadow-sm">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="p-4">
                        ...
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Sous-total </strong><strong>{{ getPrice(Cart::subtotal(2,',','')) }}</strong></li>
                        {{-- <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Shipping and handling</strong><strong>$10.00</strong></li> --}}
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Taxe</strong><strong>{{ getPrice(Cart::tax(2,',','')) }}</strong></li>
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Total</strong>
                            <h5 class="font-weight-bold">{{ getPrice(Cart::total(2,',','')) }}</h5>
                        </li>
